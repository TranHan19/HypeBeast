 ...
 */
get_header(); 
$latest_post_column = kuza_minimal_blog_get_option( 'number_of_latest_posts_column' );
$latest_section_posts_title = kuza_minimal_blog_get_option( 'latest_section_posts_title' );
	...
	<div class="wrapper page-section">
		...
		<div id="primary" class="content-area">
			<main id="main" class="site-main blog-posts-wrapper" role="main">
				...
				<?php 	/**
			* Hook - kuza_minimal_blog_pagination_action.
			*
			* @hooked kuza_minimal_blog_pagination 
			*/
			 do_action('kuza_minimal_blog_pagination_action');?>
			</main><!-- #main -->
		</div><!-- #primary -->
