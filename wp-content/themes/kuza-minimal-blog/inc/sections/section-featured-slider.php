 ...
 *@package Kuza
 */
    $sr_content_type   = kuza_minimal_blog_get_option( 'sr_content_type' );
    $number_of_sr_items = kuza_minimal_blog_get_option( 'number_of_sr_items' );
    $slider_layout = kuza_minimal_blog_get_option( 'slider_layout_option' );
    $slider_column = kuza_minimal_blog_get_option( 'number_of_sr_column' );
    $slider_category = kuza_minimal_blog_get_option( 'slider_category' );
    $enable_content     = kuza_minimal_blog_get_option( 'slider_content_enable' );
    $enable_title     = kuza_minimal_blog_get_option( 'slider_title_enable' );
    $enable_category     = kuza_minimal_blog_get_option( 'slider_category_enable' );
    $enable_posted_on     = kuza_minimal_blog_get_option( 'slider_posted_on_enable' );
    $slider_speed   = kuza_minimal_blog_get_option( 'slider_speed' );
    $slider_dot   = kuza_minimal_blog_get_option( 'slider_dot' );
    $slider_arrow   = kuza_minimal_blog_get_option( 'slider_arrow_enable' );
    $slider_autoplay  = kuza_minimal_blog_get_option( 'slider_autoplay_enable' );
    $slider_infinite  = kuza_minimal_blog_get_option( 'slider_infinite_enable' );
    $slider_fade  = kuza_minimal_blog_get_option( 'slider_fade_enable' );
    $image_overlay   = kuza_minimal_blog_get_option( 'disable_white_overlay' );
    $header_font_size = kuza_minimal_blog_get_option( 'slider_font_size');
    $slider_background_color = kuza_minimal_blog_get_option( 'slider_background_color');
    $slider_content_position = kuza_minimal_blog_get_option( 'slider_content_position_option');
    $slider_social_text = kuza_minimal_blog_get_option( 'slider_social_title_text');
    $slider_alt_btn_text = kuza_minimal_blog_get_option( 'slider_alt_custom_btn_text');
    $slider_alt_btn_url = kuza_minimal_blog_get_option( 'slider_alt_custom_btn_url');
    $slider_social_link  = kuza_minimal_blog_get_option( 'slider_social_link' );
    ...
    for( $j=1; $j<=$number_of_sr_items; $j++ ) :
        $featured_slider_page_posts[] = kuza_minimal_blog_get_option( 'slider_page_'.$j );
        $featured_slider_posts[] = kuza_minimal_blog_get_option( 'slider_post_'.$j );
    endfor;
    ?>
    <style>
                        ...
                        <div class="<?php echo esc_attr($class); ?> featured-content-wrapper">
                            <header class="entry-header">
                                ...
                                <?php if ($enable_title==true):
                                    $featured_slider_before_title = kuza_minimal_blog_get_option( 'slider_title_meta_'.$j );
                                    $featured_slider_after_title = kuza_minimal_blog_get_option( 'slider_after_title_'.$j );
                                 ?>
                            ...
                            <?php if ( ($enable_content==true)): ?>
                                <div class="entry-content">
                                    <?php
                                        $excerpt = kuza_minimal_blog_the_excerpt( 30 );
                            ...
                            <?php if ( ($enable_posted_on==true)) { ?>
                                <div class="entry-meta">                 
                                    <?php kuza_minimal_blog_posted_on(); ?>
                                </div><!-- .entry-meta -->
                            <?php } ?>
                            <?php
                            $readmore_text   = kuza_minimal_blog_get_option( 'slider_custom_btn_text_' . $j ); 
