...
class Kuza_Minimal_Blog_Dropdown_Chooser extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="kuza-minimal-blog-chosen-select" <?php $this->link(); ?>>
                    <?php
...
class Kuza_Minimal_Blog_Dropdown_Multiple_Chooser extends WP_Customize_Control{
    ...
    public function render_content(){
        ...
        ?>
            <label>
                ...
                <select class="kuza-minimal-blog-chosen-select" multiple <?php $this->link(); ?>>
                    <?php
                    foreach ( $this->choices as $value => $label )
                        echo '<option value="' . esc_attr( $value ) . '"' . selected( $this->value(), $value, false ) . '>' . esc_html( $label ) . '</option>';
                    ?>
...
Class Kuza_Minimal_Blog_Customize_Horizontal_Line extends WP_Customize_Control {
    public $type = 'hr';
...
class Kuza_Minimal_Blog_Multi_Input_Custom_Control extends WP_Customize_Control {
    /**
     * Control type
     *
     * @var string
...
class Kuza_Minimal_Blog_Note_Control extends WP_Customize_Control {
